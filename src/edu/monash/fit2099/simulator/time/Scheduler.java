...
public class Scheduler {
	...
	// Allow switching to different planets
	...
	/**
	 * Methods to check if game is lost or won.
	 * Lost if <code>PrincessLeia</code> or <code>Player</code> dies
	 * Won if <code>DarthVader</code> dies or <code>Player</code> brings <code>PrincessLeia</code> and <code>Artoo</code> to <code>YavinIV</code>
	 * 
	 * @author 	Matthew
	 * 
	 * @see <code>DarthVader</code>
	 * @see <code>Player</code>
	 * @see <code>Princess Leia</code>
	 * 
	 */
