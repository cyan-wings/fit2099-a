...
public class TrainJedi extends SWAffordance {
	...
	if(!actor.hasCapability(Capability.RESIST_DARK_SIDE))
	{
	    actor.addCapability(Capability.RESIST_DARK_SIDE);
	    actor.removeCapability(Capability.JEDI_STUDENT);
	    actor.say(String.format("%s can resist the dark side.", actor.getShortDescription()));
