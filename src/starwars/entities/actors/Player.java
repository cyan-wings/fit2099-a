...
import starwars.actions.TravelToDeathStar;
import starwars.actions.TravelToYavin;
...
public class Player extends SWOrganicActor {
	...
	for (SWEntityInterface entity: contents) {
		if (entity instanceof MilleniumFalcon){
			TravelToDeathStar deathStar = new TravelToDeathStar(this,messageRenderer);
			this.addAction(deathStar);
			TravelToYavin yavin = new TravelToYavin(this,messageRenderer);
			this.addAction(yavin);
		}
	}
    ...
    /**
     * This method will describe, 
     * As <code>Player</code> is turned to dark side, game is lost.
     * 
     *  @see {@link edu.monash.fit2099.simulator.userInterface.MessageRenderer}
     *  @see <code>VaderBehaviour</code>
     */
    public void turnToDarkSide() {
    	scheduler.loseGame();
    }
    
    /**
     * This method will describe, 
     * As <code>Player</code>'s hitpoints go below 0, game is lost.
     * 
     */
    @Override
